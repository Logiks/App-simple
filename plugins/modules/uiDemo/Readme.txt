...
This module provides quick pages for your demo/themes. You can simply invoke loadModuleComponent("uiDemo","<component/page name>").
...
You can also use them as code snippets for using in your own application.
