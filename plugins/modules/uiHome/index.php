    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="alert alert-success alert-dismissable">
          ...
          Welcome to _backend App. This app uses startbootstrap SB Admin Theme, <a class="alert-link" href="http://startbootstrap.com" target=_blank>Start Bootstrap</a>! Feel free to use this app for all your admin needs!
        </div>
      </div>
    </div>
